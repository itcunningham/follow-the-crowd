...
/**
 * Shared read-only chip row for profile tag lists (music genres). A chip's
 * `title` gives desktop mouse users a native hover tooltip for a truncated
 * value; Event Brands on the public profile use their own interactive
 * `EventBrandsChips` component instead (a tap-to-open bottom sheet), since a
 * hover-only tooltip has no touch equivalent.
 */
