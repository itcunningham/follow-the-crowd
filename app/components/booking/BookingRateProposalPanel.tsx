...
const PROPOSAL_PRIMARY_ACTION_CLASS =
  "inline-flex min-h-10 min-w-0 flex-1 items-center justify-center rounded-md bg-ftc-primary px-3 py-2 text-xs font-medium text-ftc-text transition disabled:cursor-not-allowed disabled:opacity-50";
