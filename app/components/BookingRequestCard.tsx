            ...
            {showDjOpenOfferActions ? (
              <>
                <button
                  ...
                  className="inline-flex min-h-10 w-full items-center justify-center rounded-xl bg-ftc-primary px-3 py-2 text-xs font-medium text-ftc-text-inverse transition disabled:cursor-not-allowed disabled:opacity-50"
                >
                  Accept offer
                </button>
                {onProposeRate ? (
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  onClick={onAccept}
                  disabled={actionDisabled}
                  className="inline-flex min-h-10 flex-[1.08] items-center justify-center rounded-xl bg-ftc-primary px-3 py-2 text-xs font-medium text-ftc-text-inverse transition disabled:cursor-not-allowed disabled:opacity-50"
                >
                  Accept
                </button>
              </div>
