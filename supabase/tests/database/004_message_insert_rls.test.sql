...
-- ============================================================================
-- TEST SUITE: Message Insert Authorization (4 assertions)
-- ============================================================================
...
SELECT lives_ok(
  'INSERT INTO public.messages (id, conversation_id, user_id, body) VALUES (''55555555-5555-4555-5555-555555555555''::uuid, ''11111111-1111-4111-1111-111111111111''::uuid, ''aaaaaaaa-aaaa-4aaa-aaaa-aaaaaaaaaaaa''::text, ''Member insert'');',
...
SELECT throws_ok(
  'INSERT INTO public.messages (id, conversation_id, user_id, body) VALUES (''66666666-6666-4666-6666-666666666666''::uuid, ''11111111-1111-4111-1111-111111111111''::uuid, ''bbbbbbbb-bbbb-4bbb-bbbb-bbbbbbbbbbbb''::text, ''Spoofed insert'');',
  '42501'
);
...
SELECT throws_ok(
  'INSERT INTO public.messages (id, conversation_id, user_id, body) VALUES (''77777777-7777-4777-7777-777777777777''::uuid, ''11111111-1111-4111-1111-111111111111''::uuid, ''cccccccc-cccc-4ccc-cccc-cccccccccccc''::text, ''Non-member insert'');',
  '42501'
);
