-- Phase 2c Baseline Migration: Pre-001 Schema Bootstrap
...
-- Does NOT create: auth schema, auth roles, or Supabase system objects.
...
-- Public schema already exists. Ensure authenticated role has USAGE.
...
create index if not exists event_run_sheet_rows_dj_id_idx
  on public.event_run_sheet_rows (dj_id);
...
-- PUBLIC.EVENT_RUN_SHEET_COLUMNS & ROWS — Authenticated: select if owner or crew
...
create policy "event_run_sheet_columns_select_crew"
  ...
  using (
    exists (
      ...
      where e.id = event_id
        and (
          e.owner_id = public.auth_user_id()
          or public.is_event_crew_participant(e.id, public.auth_user_id())
        )
    )
  );
...
-- ============================================================================
-- REALTIME PUBLICATION (created by migrations 007/009, prepare here)
-- ============================================================================
