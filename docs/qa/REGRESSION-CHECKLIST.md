...
| DJ decline incoming invite | **Passed** |
...
| R-46 | **Fixed 2026-09-01** (`03c34999`). Build gate clean; main table **Partial** until Isaac re-checks Production console | Live browser console on Production not explicitly re-checked |
