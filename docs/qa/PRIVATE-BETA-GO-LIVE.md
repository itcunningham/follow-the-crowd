...
| `QA-BETA-*` data cleaned or isolated | **Script ready** | Run `docs/qa/FTC-BETA-ENVIRONMENT-RESET.md` (Step 4) before official beta testing |
...
| OP-10 | Existing `QA-BETA-*` data safely cleaned or isolated | ☐ Run `scripts/resetQaEnvironment.sql` — see `docs/qa/FTC-BETA-ENVIRONMENT-RESET.md` |
