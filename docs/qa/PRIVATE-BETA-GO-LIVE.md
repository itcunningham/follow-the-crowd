...
| `QA-BETA-*` data cleaned or isolated | **Script ready** | `docs/qa/FTC-BETA-ENVIRONMENT-RESET.md` |
...
| OP-10 | Existing `QA-BETA-*` data safely cleaned or isolated | ☐ Paste `scripts/resetQaEnvironment.sql` in SQL Editor — see runbook |
