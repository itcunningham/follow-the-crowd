...
Cursor may update `CURRENT-STATE.md` (and other handoff files) when shipping a meaningful feature or workflow change.

You can also ask: **Update docs/handoff/CURRENT-STATE.md**
