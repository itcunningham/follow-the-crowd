...
- Agenda/grid ordering: chronological by start time, then end time, then created-at/id tie-break (`sortPlannerCalendarAgendaItems`); status does not affect order
