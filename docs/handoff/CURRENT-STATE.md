...
- **Gigs mobile cards (2026-07-15):** unified venue/time/offer block; Open DM centred beside info on Incoming mobile; `getGigCardOfferSummary` uses same `Fixed ·` / `Open offer` copy on Incoming and Confirmed
