...
- **DM booking expand scroll (2026-07-27):** chat scroller uses standard column scroll (`scrollTop` max = newest); View details aligns expanded card below fixed header
