...
- **DM booking system messages (2026-07-27):** booking event pills removed; rate/accept/decline/confirm/cancel timeline uses centred `GroupChatSystemNotice` copy (e.g. `DJ proposed a rate of $111.`); booking card remains source of truth for current state
