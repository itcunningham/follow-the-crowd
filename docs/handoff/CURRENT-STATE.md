...
- **Messages & Profile desktop:** Messages inbox uses `APP_DM_CONTENT_WIDTH_CLASS` (`max-w-2xl lg:max-w-[52rem]`); **Profile** uses matching `AppProfilePageShell` with two-column grid `minmax(18rem,21.25rem)` + flexible right column
