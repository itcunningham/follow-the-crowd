...
- **Withdrawal Other reason field (2026-07-25):** DJ withdraw / planner cancel “Other” details use `WithdrawalReasonDetailsField` — fixed ~3-row height with internal scroll; hard 120-character limit + 3 explicit newline cap via `sanitizeWithdrawalOtherReasonInput`; live `n/120` counter; word wrap no longer blocks typing; reason chips and submit logic unchanged
