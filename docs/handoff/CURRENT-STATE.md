...
- **Events list card polish (2026-07-20):** grid layout aligned with Gigs — artwork anchors header/schedule, title row with status + chevron, full-width bordered booking summary panel
