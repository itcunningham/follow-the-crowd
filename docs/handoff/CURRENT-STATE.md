...
- **Propose rate modal copy (2026-07-26):** notes field label `Notes (optional)`; placeholder `Notes`; description sentence without trailing full stop; notes textarea uses modal standard `.ftc-fixed-scroll-textarea-3` (~3 visible lines, internal scroll)
