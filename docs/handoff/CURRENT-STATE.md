...
- **Events list card polish (2026-07-20):** Gigs-matched flex rhythm — title/chevron row, combined meta block, status then compact stat chips (no nested summary panel)
