...
- **Booking rate proposal actions (2026-07-28):** planner review panel — equal-width side-by-side row **Accept** + **Decline** (ask-for-rate) or **Keep offer** (fixed-rate); `min-h-8` / `gap-2` matches DM paired action rows; full-width **View event** below unchanged
