...
- **Events History controls (2026-07-20):** remove confirmation + selection toolbar live in fixed-height `EventsListTabRow` (feedback between pills and trash, ~3s fade); no extra row above cards
