...
- **Event Plan card overflow (2026-07-26):** mobile Event/Venue values and desktop Event/Venue fields truncate with ellipsis; labels stay shrink-0; plan title truncates; notes two-line clamp unchanged
