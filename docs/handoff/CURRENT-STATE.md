...
- **Gigs tab row (2026-07-19):** shared `DjGigsTabs` + `DjGigsTabRow` use compact content-width pills (`GIGS_TAB_PILL_ROW_CLASS`), a nowrap row (`GIGS_LIST_TAB_ROW_CLASS`), reserved count slots, and a reserved History manage slot so tabs, counts and bin load as one stable unit without wrapping at 390px
