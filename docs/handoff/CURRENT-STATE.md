...
- **Gigs History inline feedback (2026-07-25):** Events + Gigs History removal success share `useHistoryRemovalHeaderFeedback` (2700ms visible + 300ms fade + clear at 3000ms) via centred `PlannerWorkspaceTitleFeedback` in the planner title row (`Events`/`Gigs` left, message centred; `{n} event(s)/gig(s) removed from history`, no trailing period); secondary tab rows stay controls-only (Active/History/trash or Incoming/Confirmed/History/trash)
