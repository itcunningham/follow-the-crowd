...
- **DM composer photo staging (2026-07-25):** selected image shows in-composer preview with blue ring; Send uploads caption + photo; preview clears only after successful send (kept on upload failure or manual remove)
