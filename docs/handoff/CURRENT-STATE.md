...
- **Gigs → DM booking deep link (2026-07-14):** `Open conversation` passes `bookingRequestId` query param; DM scrolls target booking card into view; full-card 2px primary inset focus ring holds ~2s then fades ~1s (no layout shift)
