...
export const PLANNER_WORKSPACE_TITLE_FEEDBACK_ANCHOR_CLASS =
  "pointer-events-none absolute inset-x-0 top-full z-50 mt-1.5 h-0";

/** @deprecated Inline slot render — feedback is portaled via PlannerTitleFeedbackOverlay. */
...
/** Fixed overlay shell positioned from the shared title-row feedback anchor. */
export const PLANNER_WORKSPACE_TITLE_FEEDBACK_OVERLAY_CLASS =
  "pointer-events-none fixed z-[60] flex items-start justify-center";
