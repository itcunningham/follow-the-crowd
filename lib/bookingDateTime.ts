...
export const BOOKING_TIME_BUTTON_COMPACT_CLASS =
  "inline-flex w-full min-h-[2.25rem] items-center gap-1 rounded-full border border-zinc-800/90 bg-[#121214] px-2.5 py-1 text-xs font-medium text-zinc-100 outline-none transition hover:border-blue-500/35 focus:border-blue-500/45 focus:ring-1 focus:ring-blue-500/20 sm:min-h-[2rem] lg:max-w-[6.25rem]";
